...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Les noms originaux doivent être uniques pour un même utilisateur.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `photo_tag` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id_idx` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Mot-clé photo';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Table de jointure entre Photo et PhotoTag.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `occurrence_user_occurrence_tag` (
  ...
  CONSTRAINT `FK_B06FBA5830572FAC` FOREIGN KEY (`occurrence_id`) REFERENCES `occurrence` (`id`),
  CONSTRAINT `FK_B06FBA58768D75C5` FOREIGN KEY (`user_occurrence_tag_id`) REFERENCES `user_occurrence_tag` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Table de jointure entre occurrence et user_occurrence_tag.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `photo` (
  ...
  KEY `user_id_idx` (`user_id`),
  CONSTRAINT `FK_14B7841830572FAC` FOREIGN KEY (`occurrence_id`) REFERENCES `occurrence` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Les noms originaux doivent être uniques pour un même utilisateur.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `photo_tag` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id_idx` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Mot-clé photo';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `photo_tag_photo` (
  ...
  CONSTRAINT `FK_3BA5CB3F7E9E4C8C` FOREIGN KEY (`photo_id`) REFERENCES `photo` (`id`),
  CONSTRAINT `FK_3BA5CB3FEF6D1439` FOREIGN KEY (`photo_tag_id`) REFERENCES `photo_tag` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Table de jointure entre Photo et PhotoTag.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_occurrence_tag` (
  ...
  UNIQUE KEY `user_id__name` (`user_id`,`name`),
  KEY `user_id_idx` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Les noms de tags utilisateurs doivent être uniques (pour un même utilisateur).';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-04-25 11:22:31
